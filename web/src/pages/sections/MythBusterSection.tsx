...
export const MythBusterSection = (): JSX.Element | null => {
  ...
  const cardStyle = {
    ...
    background: "#ffffff",
    minHeight: 420,
    boxShadow: "0 8px 48px -8px rgba(0,125,131,0.13), 0 2px 16px -4px rgba(0,0,0,0.06)",
    ...
    <section className="w-full py-14 lg:py-24" style={{ background: "#f7fafa" }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <p className="text-[10px] font-bold tracking-[0.22em] uppercase text-[#007d83] mb-3">
            Медицина vs мифы
          </p>
        ...
        <div className="flex flex-col items-center gap-10">
          ...
          <div className="w-full max-w-lg" style={{ minHeight: 432 }}>
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                ...
                {!showBack && (
                  <div style={cardStyle}>
                    <div className="h-[3px]" style={{ background: "linear-gradient(90deg,#007d83,#00b4bd)", flexShrink: 0 }} />
                    ...
                    <div className="flex flex-col flex-1 p-8 lg:p-10 relative overflow-hidden">
                      ...
                      <span
                        ...
                        style={{ fontSize: 160, lineHeight: 1, color: "#007d83", opacity: 0.04 }}
                      >?</span>

                      <div className="flex items-center justify-between mb-7">
                        <span className="inline-flex items-center gap-1.5 text-[10px] font-bold tracking-[0.18em] uppercase text-[#007d83]">
                  ...
                  <div style={cardStyle}>
                    ...
                    <div className="flex flex-col flex-1 p-8 lg:p-10">
                      ...
                      <a
                        ...
                        style={{ background: "#007d83", color: "#fff" }}
                      >
          ...
          <div className="flex items-center gap-5">
            <motion.button
              ...
              className="flex items-center justify-center h-11 w-11 rounded-full bg-white text-gray-400 hover:text-[#007d83] transition-colors"
            ...
            <div className="flex items-center gap-2">
              {myths.map((m, i) => (
                <motion.button
                  ...
                  style={{ background: i === safeCurrent ? "#007d83" : "#d1d5db" }}

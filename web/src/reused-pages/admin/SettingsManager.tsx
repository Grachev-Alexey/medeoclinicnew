  ...
  return (
    <div>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl">Настройки сайта</h1>
          <p className="mt-1 text-sm text-gray-500">Шапка, контакты, реквизиты</p>
        </div>
        <Button onClick={saveAll} disabled={saving} data-testid="button-save-settings" className="w-full sm:w-auto">

...
const accentPalette = ["#a03050", "#1e3a5f", "#7c5a0f", "#005eb8", "#5b21b6", "#1e72c8"];
...
export const ServiceOverviewSection = (): JSX.Element | null => {
  ...
  return (
    <section className="w-full bg-[#f8f9fb] pt-8 pb-14 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          ...
          <a
            href="#"
            className="hidden sm:inline-flex items-center gap-2 text-sm font-medium text-[#005eb8] hover:gap-3 transition-all"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-5 items-start">
          ...
          <div className="w-full lg:w-[44%] flex flex-col gap-2.5">
            {categories.map((cat, i) => {
              ...
              const toggle = () => setActiveId(isOpen ? null : cat.id);
              return (
                <div
                  key={cat.id}
                  role="button"
                ...
                >
                  ...
                  <Icon
                    ...
                    style={{ color: accent, opacity: isOpen ? 0.12 : 0.04 }}
                  />
                  {/* Header row */}
